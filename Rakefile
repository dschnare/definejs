...
FileList[JS_SOURCE_GLOB].each do |src|
...
# Copy a version of definejs to the amdjs-test testing suite.
task :default do |t|
	cp File.join(JS_OUT_DIR, 'define.min.js'), 'web/public/amdjs-tests/impl/definejs/define.js'
end
